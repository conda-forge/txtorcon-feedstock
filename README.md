...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/txtorcon-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13772&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/txtorcon-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `txtorcon` can be installed with:

```
conda install txtorcon
```

It is possible to list all of the versions of `txtorcon` available on your platform with:
